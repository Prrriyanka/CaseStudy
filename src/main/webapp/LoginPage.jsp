...
<body>
	...
	<div class="container">
		...
		<div class="box">
			<h1 class="techno">Login Page</h1>
<!-- 			action me UserLoginServlet ya developer kaise
 -->			
			<form class="form" name="RegForm" action="login"  method="post">

				<label for="userName">User Name</label> <br> 
				<input class="input100" type="text" name="userName" id="userName" placeholder="Enter your username " required="required"> <br><br> 
					
				<label for="pass">Password</label><br> 
				<input class="input100"type="password" name="passWord" id="pass" placeholder="Enter your password" required="required" > <br> <br> 
